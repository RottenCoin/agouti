...
RESOURCES += src/qt/agouti.qrc src/qt/agouti_locale.qrc

TRANSLATIONS += src/qt/locale/agouti_bg.ts \
                src/qt/locale/agouti_de.ts \
                src/qt/locale/agouti_en.ts \
                src/qt/locale/agouti_es.ts \
                src/qt/locale/agouti_fi.ts \
                src/qt/locale/agouti_fr.ts \
                src/qt/locale/agouti_it.ts \
                src/qt/locale/agouti_ja.ts \
                src/qt/locale/agouti_pl.ts \
                src/qt/locale/agouti_pt.ts \
                src/qt/locale/agouti_ru.ts \
                src/qt/locale/agouti_sk.ts \
                src/qt/locale/agouti_sv.ts \
                src/qt/locale/agouti_vi.ts \
                src/qt/locale/agouti_zh_CN.ts \
                src/qt/locale/agouti_zh_TW.ts

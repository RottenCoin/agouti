Contributing to Agouti Core
============================

The Agouti Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Agouti Core project, and is not to be
confused with overall Agouti Network Protocol consensus changes.

Whether a pull request is merged into Agouti Core rests with the project merge
...
Patches that change Agouti consensus rules are considerably more involved than
...
Where a patch set proposes to change the Agouti consensus, it must have been
...
The project leader is the release manager for each Agouti Core release.

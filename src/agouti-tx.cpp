...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Agouti Core agouti-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  agouti-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded agouti transaction") + "\n" +
                               "  agouti-tx [options] -create [commands]   " + _("Create hex-encoded agouti transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded agouti transaction

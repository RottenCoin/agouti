...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zagoutiObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zagoutiObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zAGUsupply", zagoutiObj));

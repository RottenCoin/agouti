...
/** Utility functions used by the Agouti Qt UI.
 */
namespace GUIUtil
{
...
// Render Agouti addresses in monospace font
...
// Parse "agouti:" URI into recipient object, return true on successful parsing

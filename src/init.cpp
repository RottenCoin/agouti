...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-litemode=<n>", strprintf(_("Disable all Agouti specific functionality (Masternodes, Zerocoin, SwiftX, Budgeting) (0-1, default: %u)"), 0));
    ...
    strUsage += HelpMessageOpt("-backupzagouti=<n>", strprintf(_("Enable automatic wallet backups triggered after each zAgouti minting (0-1, default: %u)"), 1));

//    strUsage += "  -anonymizeagoutiamount=<n>     " + strprintf(_("Keep N AGU anonymized (default: %u)"), 0) + "\n";
    ...
    while (!fLoaded) {
        ...
        do {
            try {
                ...
                // Agouti: recalculate Accumulator Checkpoints that failed to database properly

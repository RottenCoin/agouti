...
In order to support loading of multiple wallets in agouti-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is agouti.cpp.
...
Changes to agouti.cpp
----------------------
agouti.cpp is the entry point into agouti-qt, and as such, will require some minor modifications to provide hooks for
